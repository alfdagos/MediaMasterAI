package it.alf.mediarenamer.cli;

import it.alf.mediarenamer.cache.DatabaseManager;
...
import it.alf.mediarenamer.enrichment.MetadataEnrichmentService;
import it.alf.mediarenamer.metadata.AudioMetadataExtractor;
import it.alf.mediarenamer.metadata.ImageMetadataExtractor;
import it.alf.mediarenamer.metadata.VideoMetadataExtractor;
import it.alf.mediarenamer.model.MediaFile;
import it.alf.mediarenamer.rename.*;
...
/**
 * MediaRenamer CLI — entry point for all subcommands.
 *
 * <p>Exit codes:</p>
 * <ul>
 ...
 * <p>Usage examples:</p>
 * <pre>{@code
 *   media-renamer scan    ~/Pictures --depth 5
 *   media-renamer preview ~/Pictures --strategy DATE_LOCATION
 *   media-renamer rename  ~/Pictures --strategy DATE_LOCATION --yes
 *   media-renamer undo
 * }</pre>
 */
@Command(
    ...
    subcommands = {
        MediaRenamerCLI.ScanCommand.class,
        MediaRenamerCLI.PreviewCommand.class,
        MediaRenamerCLI.RenameCommand.class,
        MediaRenamerCLI.UndoCommand.class,
        MediaRenamerCLI.DuplicatesCommand.class,
        MediaRenamerCLI.CacheClearCommand.class
    }
)
public class MediaRenamerCLI implements Runnable {

    private static final Logger log = LoggerFactory.getLogger(MediaRenamerCLI.class);
    ...
    public static void main(String[] args) {
        int exit = new CommandLine(new MediaRenamerCLI())
